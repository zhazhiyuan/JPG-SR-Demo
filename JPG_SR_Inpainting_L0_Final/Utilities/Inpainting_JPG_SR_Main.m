function  [filename, p_miss, mu,  j, PSNR_Final,FSIM_Final,SSIM_Final,Time_s, Err_or]= Inpainting_JPG_SR_Main(filename, IterNum, p_miss, mu,c1, Err_or )
     ...
     [reconstructed_image, PSNR_Final,FSIM_Final,SSIM_Final, All_PSNR,j, Err_or] = Inpainting_JPG_SR(y,Options, Err_or);
      ...
      Time_s                         =                 (etime(clock,time0)); 
        ...
        imwrite(uint8(x_inpainting_recon),strcat('./50_Missing_Results/',Final_Name));
                ...
                Final_Name= strcat(filename,'_JPG_SR_text_', '_PSNR_',num2str(PSNR_Final), '_FSIM_',num2str(FSIM_Final), '_SSIM_',num2str(SSIM_Final),'.png');
